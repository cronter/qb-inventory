...
let clickedOutfitItemData = null

$(document).on("click", "#item-changelabel", function (e) {
    if (clickedOutfitItemData != null) {
        $('.label-input p').text('Enter Label for ' + clickedOutfitItemData.label)
        $('.label-input').fadeIn(50);
    }
})

$(document).on("click", ".accept-label", function (e) {

    if (clickedOutfitItemData != null) {
        let val = $('.label-type-input').val()

        $.post("https://qb-inventory/changeOutfitLabel", JSON.stringify({
            itemData: clickedOutfitItemData,
            newLabel: val,
        }))
        closeChangeLabel()
...
$(document).on("click", ".cancel-label", function (e) {

    closeChangeLabel()
})


function closeChangeLabel(){

    $('.label-input').fadeOut(50, function () {
        $('.label-type-input').val('')


        $('.label-input p').text('');
        clickedOutfitItemData = null
...
$(document).on("click", ".item-slot", function (e) {
    ...
    if (ItemData !== null && ItemData !== undefined) {
        if (ItemData.name !== undefined) {
            ...
            } else if (ItemData.name.startsWith('clothes') || ItemData.name == 'outfit_bag') {
                $('#item-changelabel').css('display', 'block');
                clickedOutfitItemData = ItemData;

            } else {
                $('#item-changelabel').css('display', 'none');
...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
        ...
        } else if(itemData.name == 'polaroid_image' && itemData.info.url){
            console.log('url : ', itemData.info.url)
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<img class="polaroid_image" src="' + itemData.info.url +'">');
        }
            ...
            if (itemData.info.type == "casing") {
                ...
                $(".item-info-description").html('<p><strong>Evidence material: </strong><span>' + itemData.info.label + '</span></p><p><strong>Fingerprint: </strong><span>' + itemData.info.fingerprint + '</span></p><p><strong>Plaats delict: </strong><span>' + itemData.info.street + '</span></p><br /><p>' + itemData.description + '</p>');
        ...
        } else if (itemData.name.startsWith('clothes')) {

            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>Value: ' + itemData.info.value + '</p ><p>Outfit Label: ' + itemData.info.label + '</p><p>Outfit Texture: ' + itemData.info.texture);

        } else if (itemData.name == 'phone') {
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            console.log(JSON.stringify(itemData.info))
            if(itemData.info.phone_number){
                $(".item-info-description").html('<p>Phone Number: ' + itemData.info.phone_number)
            }else{
                $(".item-info-description").html("<p>Phone Number: Couldn't find")

            }
        } else if (itemData.name == 'outfit_bag') {
            let html = ''
            $(".item-info-title").html('<p>' + itemData.label + '</p>')

            html = '<p>Outfit Label: ' + itemData.info.label + '</p>'


            $(".item-info-description").html(html);

        } else if (itemData.name == 'cront_bag1') {
            let html = ''
            $(".item-info-title").html('<p>' + itemData.label + '</p>')

            html = '<p>Stitched : ' + itemData.info.bagname + '</p>'
            ...
            html = '<p>worth: ' + itemData.info.worth + '</p>'
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if ((toData != undefined || toData != null) && toData.name == fromData.name && !fromData.unique) {
            ...
            if (fromData.amount == $toAmount) {
                ...
                } else if (($toSlot == 41 || $toSlot == 40 ||$toSlot == 39 ||$toSlot == 38 || $toSlot == 37) && $toInv.attr("data-inventory") == "player") {
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newData.image + '" alt="' + newData.name + '" /></div><div class="item-slot-amount"><p>' + newData.amount + ' (' + ((newData.weight * newData.amount) / 1000).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
              ...
              //  if ((newData.name).split("_")[0] == "weapon") {
                    //if (!Inventory.IsWeaponBlocked(newData.name)) {
                        ...
                        var QualityColor = "rgb(168, 184, 117)";
                ...
                if ($fromInv.attr("data-inventory").split("-")[0] == "itemshop") {
                    ...
                    } else if (($fromSlot == 41 || $fromSlot == 40 ||$fromSlot == 39 ||$fromSlot == 38 || $fromSlot == 37) && $fromInv.attr("data-inventory") == "player") {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newDataFrom.image + '" alt="' + newDataFrom.name + '" /></div><div class="item-slot-amount"><p>' + newDataFrom.amount + ' (' + ((newDataFrom.weight * newDataFrom.amount) / 1000).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else {
            ...
            if (fromData.amount == $toAmount) {
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    ...
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + fromData.image + '" alt="' + fromData.name + '" /></div><div class="item-slot-amount"><p>' + fromData.amount + ' (' + ((fromData.weight * fromData.amount) / 1000).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
                ...
                if (toData != undefined) {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        ...
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + toData.image + '" alt="' + toData.name + '" /></div><div class="item-slot-amount"><p>' + toData.amount + ' (' + ((toData.weight * toData.amount) / 1000).toFixed(1) + ')</p></div>' + ItemLabel);
                    } else {
                    ...
                    if ($fromSlot < 6 && $fromInv.attr("data-inventory") == "player") {
                        ...
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"></div><div class="item-slot-label"><p>&nbsp;</p></div>');
                    } else {
                        $fromInv.find("[data-slot=" + $fromSlot + "]").html('<div class="item-slot-img"></div><div class="item-slot-label"><p>&nbsp;</p></div>');
                    }
                ...
                if ($toSlot < 6 && $toInv.attr("data-inventory") == "player") {
                    ...
                    $toInv.find("[data-slot=" + $toSlot + "]").html('<div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + newDataTo.image + '" alt="' + newDataTo.name + '" /></div><div class="item-slot-amount"><p>' + newDataTo.amount + ' (' + ((newDataTo.weight * newDataTo.amount) / 1000).toFixed(1) + ')</p></div>' + ItemLabel);
                } else {
...
(() => {
    ...
    Inventory.Open = function (data) {
        ...
        for (i = 6; i < (data.slots + 1); i++) {
            if ((i == 41 || i == 40 || i == 39 || i == 38 || i == 37)) {
                $(".player-inventory").append('<div class="item-slot" data-slot="' + i + '"><div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"></div><div class="item-slot-label"><p>&nbsp;</p></div></div>');
            } else {
        ...
        if (data.inventory !== null) {
            $.each(data.inventory, function (i, item) {
                if (item != null) {
                    ...
                    } else if ((item.slot == 41 || item.slot == 40 || item.slot == 39 || item.slot == 38 || item.slot == 37)) {
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").addClass("item-drag");
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.amount + ' (' + ((item.weight * item.amount) / 1000).toFixed(1) + ')</p></div>' + ItemLabel);
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").data("item", item);
                    } else {
                        $(".player-inventory").find("[data-slot=" + item.slot + "]").addClass("item-drag");
        ...
        $.each(data.inventory, function (i, item) {
            if (item != null) {
                ...
                if (item.slot < 6) {
                    ...
                    $(".player-inventory").find("[data-slot=" + item.slot + "]").addClass("item-drag");
                    $(".player-inventory").find("[data-slot=" + item.slot + "]").html('<div class="item-slot-key"><p>Protected <i class="fas fa-lock"></i></p></div><div class="item-slot-img"><img src="images/' + item.image + '" alt="' + item.name + '" /></div><div class="item-slot-amount"><p>' + item.amount + ' (' + ((item.weight * item.amount) / 1000).toFixed(1) + ')</p></div><div class="item-slot-label"><p>' + item.label + '</p></div>');
                    $(".player-inventory").find("[data-slot=" + item.slot + "]").data("item", item);
                } else {
                    $(".player-inventory").find("[data-slot=" + item.slot + "]").addClass("item-drag");
